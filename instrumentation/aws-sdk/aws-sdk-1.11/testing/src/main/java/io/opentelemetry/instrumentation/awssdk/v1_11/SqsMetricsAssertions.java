...
final class SqsMetricsAssertions {
  ...
  static void assertProducerMetrics(
    ...
    assertMessageCounter(
        testing, "messaging.client.sent.messages", "send", serverPort, messageCount);
  ...
  static void assertReceiveAndProcessMetrics(
    ...
    assertMessageCounter(
        testing, "messaging.client.consumed.messages", "receive", serverPort, messageCount);
  ...
  static void assertProcessFallbackMetrics(
    ...
    assertProcessDuration(testing, serverPort, messageCount);
    assertMessageCounter(
        testing, "messaging.client.consumed.messages", "process", serverPort, messageCount);
    assertThat(testing.metrics())
        .filteredOn(
            metric -> metric.getInstrumentationScopeInfo().getName().equals(INSTRUMENTATION_NAME))
        .extracting(MetricData::getName)
        .doesNotContain("messaging.client.operation.duration");
    assertNoDeprecatedMessagingMetrics(testing);
  }
